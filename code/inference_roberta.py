...
def run_sparse_retrieval(
    ...
    if os.path.exists(cache_file):
        ...
        print(f"🚀 No cache found. Running Retrieval (top_k={data_args.top_k_retrieval})...")
        ...
        # 캐시 저장 (나중을 위해)
        print(f"💾 Saving retrieval results to {cache_file}...")
        df.to_csv(cache_file, index=False)

    # 2. DataFrame -> HuggingFace Dataset 변환 (기존 로직 유지)
