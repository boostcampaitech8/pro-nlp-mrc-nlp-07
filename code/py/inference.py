...
def run_sparse_retrieval(
    ...
    # [수정됨] ElasticSearchRetrieval 사용
    # rerank_model_path는 retrieval.py에서 기본값으로 설정한 "./models/my_reranker"를 따르거나
    # 필요하다면 여기서 직접 지정할 수도 있습니다.
    ...
    # [수정됨] retrieve 메서드 호출 (Faiss 옵션 제거)
    # ElasticSearchRetrieval.retrieve는 topk 인자를 받습니다.
