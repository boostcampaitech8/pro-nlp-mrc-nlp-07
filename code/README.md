...
run_advanced.sh          # 훈련-평가-추론 

upload_model.py          # HuggingFace 모델 업로드 제공
TAPT.py                  # TAPT 학습
train_advanced.py        # MRC, Retrieval 모델 학습 및 평가 (New Ver)
inference_roberta.py     # ODQA 모델 평가 또는 제출 파일 생성
```
...
nohup ./run_advanced.sh > logs~.txt 2>&1 &
```
